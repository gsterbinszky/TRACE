...
plot4 <- rbind(oljefondet_plot4, apfc_plot4, nzsuper_plot4, abp_plot4)

plot4$Country <- factor(plot7$Country)
plot4$scope <- factor(plot7$scope, levels = c("GPFG", "ABP", "APFC", "NZ Super"))
